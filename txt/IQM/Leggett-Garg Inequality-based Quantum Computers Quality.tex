...
\begin{document}
	...
	\begin{frame}{Authors}
		...
		na całość mamy 12 minut prezentacji + 8 minut pytań
	...
	\begin{frame}{LG test}
		...
		ile uważasz o naszym protokole
		
	\end{figure}

	\begin{frame}{LG test to benchmark}
		\vspace{-1cm}
		
		Lamanie mierzone odchyleniami standardowymi
		
		Benchmark score jako confidence level łamania, liczony przez
		
		$score = erf(Z / \sqrt{2})$,
	
		gdzie $Z$ to liczba zmierzonych odchyleń standardowych.
		
		Score zamknięty w [0, 1].
	...
	\begin{frame}{Experimental pipeline}
		...
		Od symulatora -> do zaszuminego -> device / pulse level
		
		Może grafika całego przepływu, albo screen kodu z modułu pipeline?
		
	\end{figure}

	\begin{frame}{IQM Sirius Experiments results}
		\vspace{-1cm}
		
		Wyniki opracowane dowolnie. Najlepiej z wszystkich części potoku 
		eksperymentalnego, tj. od symulatorów po pullę.
		
		Jeśli mogę prosić o doliczenie benchmark score, to byłoby super.
	...
	\begin{frame}{Additional insights}
		...
		Skrócona wersja technical summary z readme w repozytorium.
	...
	\begin{frame}{Next steps}
		...
		Kolejne obwody, które omówilismy mailowo.
